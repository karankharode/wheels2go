...
List<Bike> getBikeList() {
  return <Bike>[
    Bike("Hero", "HF Deluxe", "Petrol", "5 Speed", "98 cc", "Tubeless",
        "60 kmpl", "Kick & Self", 1000, "Good", [
    ...
    Bike("Royal Enfield", "Bullet 350", "Petrol", "5 Speed", "346 cc", "Tube",
        "35 kmpl", "Kick", 3000, "Brand New", [
    ...
    Bike("Yamaha", "YZF R15 V3", "Petrol", "6 Speed", "155 cc", "Tube",
        "90 kmpl", "Kick & Self", 2500, "Good", [
    ...
    Bike("Bajaj", "Pulsar 150 ", "Petrol", "5 Speed", "149 cc", "Tube",
        "90 kmpl", "Kick", 2000, "Good", [
    ...
    Bike("TVS", "Apache RTR 160", "Petrol", "5 Speed", "159 cc", "Tubeless",
        "40 kmpl", "Kick", 2000, "Good", [
    ...
    Bike("Benling India", "Falcon", "Electricity", "CVT", "159 cc", "Tubeless",
        "73 kmpc", "Remote & Push", 1500, "Good", [
      'assets/Benling India Falcon/falcon1.jpg',
      'assets/Benling India Falcon/falcon2.jpg',
    ]),
    Bike("Royal Enfield", "Classic 350", "Petrol", "5 Speed", "346 cc",
        "Tubeless", "42 kmpl", "Kick & Self", 2500, "Good", [
    ...
    Bike("Duke", "KTM 125", "Petrol", "6 Speed", "124 cc", "Tubeless",
        "47 kmpl", "Kick & Self", 2500, "Good", [
    ...
    Bike("Bajaj", " Pulsar NS200", "Petrol", "5 speed", "199 cc", "Tubeless",
        "41 kmpl", "Kick & Self", 2000, "Good", [
    ...
    Bike("Yamaha", "FZ-Fi Version 3.0", "Petrol", "5 speed", "149 cc",
        "Tubeless", "30 kmpl", "Kick & Self", 2000, "Good", [
    ...
    Bike("Suzuki", "Gixxer SF", "Petrol", "5 speed", "155 cc", "Tubeless",
        "40 kmpl", "Kick & Self", 2000, "Good", [
    ...
    Bike("Hero", "Electric Dash", "Electricity", "5 speed", "110 cc",
        "Tubeless", "60 kmpc", "Kick & self Start", 1000, "Good", [
    ...
    Bike("Suzuki", "Access 125 ", "Petrol", "CVT", "124 cc", "Tubeless",
        "53 kmpl", "Kick & Self", 900, "Good", [
    ...
    Bike("Hero", "Super Splendor", "Petrol", "5 speed", "124 cc", "Tubeless",
        "50 kmpl", "Kick start", 1000, "Good", [
    ...
    Bike("Triumph", "Street Triple", "Petrol", "5 speed", "765 cc", "Tubeless",
        "70 kmpl", "Self", 1000, "Good", [
